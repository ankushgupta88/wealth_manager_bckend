                    ...
                    <div class="row">
                     ...
                     <div class="col-md-12">
                        ...
                        <div class="form-group col-md-12">
                           ...
                           <textarea name="quote_info" rows="4" cols="50" class="form-control" placeholder="Add your personal quote here">{{ $member[0]->quote_info }}</textarea>
                                          ...
                                          <div class="row">
                                            ...
                                            <span class="invalid-feedback" role="alert">
                                             ...
                                             <div class="form-group col-md-12 mt-4">
                                                ...
                                                <textarea name="desc" rows="4" cols="50" class="form-control" placeholder="Add Descrption here"></textarea>
                                             </div>
                                             <div class="upload-content pl-3">
                                                <p class="pt-2"> Upload a photo</p>
                  ...
                  @csrf
                    <div class="business-detail-block bg-white p-4 mb-3 rounded-3">
                     ...
                     <div class="mb-3 col-md-9">
                        ...
                        <textarea class="w-100 color-bg border-0 p-3" rows="6" cols="50" name="biography" placeholder="Add your biography">{{ $member[0]->biography }}</textarea>
                        @error('biography')
                           <span class="invalid-feedback" role="alert">
                           <strong>{{ $message }}</strong>
                           </span>
