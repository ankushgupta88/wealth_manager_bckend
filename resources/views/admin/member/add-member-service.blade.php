  ...
  <div class="col-sm-12"> <!--content-wrapper-->
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-12">
            <h1>Add Member Service </h1>
          </div>
          <div class="col-sm-12">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="{{ url('admin/dashboard') }}">Dashboard</a></li>
              <li class="breadcrumb-item active">Add Member Service</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
        ...
        <div class="col-md-9">
          <div class="card card-primary">
            <div class="card-body">
                ...
                @endif
             <form method="post" action="{{ route('admin.submit.member.service') }}" enctype="multipart/form-data">
                @csrf
